...
const HeroSection = ({ role }: IProps) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.hero-stat',
        { opacity: 0, scale: 0.8 },
        { opacity: 1, scale: 1, duration: 0.6, stagger: 0.1, delay: 1.2, ease: 'back.out(1.7)' }
      );
    }, sectionRef);
  ...
  return (
    <section className="pt-20 px-1 md:px-6" ref={sectionRef}>
      <div className="max-w-7xl mx-auto rounded-[3rem] hero-gradient p-6 sm:p-8 md:p-12 lg:p-20 relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 relative z-10">
          <div className="">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/50 dark:bg-black/20 rounded-full mb-6 sm:mb-8 border border-white/30 hero-stat">
            ...
            <h1 ref={titleRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] mb-6 sm:mb-8 tracking-tight">
              {title}
            </h1>
            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start sm:items-center">
          ...
          <div className="flex flex-col justify-end lg:pl-6 xl:pl-12" ref={imageRef}>
            <p ref={subtitleRef} className="text-base sm:text-lg opacity-80 leading-relaxed mb-8 sm:mb-10 md:mb-12">
              {subtitle}
            </p>
            <div className="relative">
              <div className="w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[400px] rounded-3xl shadow-2xl relative hero-stat">
                <Image 
                  src="/hero-doctor.jpg" 
                  alt="Hero Doctor" 
                  fill
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 glass-card p-4 sm:p-6 rounded-3xl shadow-xl max-w-[240px] sm:max-w-[280px] hero-stat">
                <div className="flex -space-x-3 sm:-space-x-4 mb-3 sm:mb-4">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-4 border-white dark:border-slate-800 bg-primary flex items-center justify-center text-[10px] sm:text-xs font-bold text-white hero-stat">2K+</div>
                </div>
