            ...
            {isAuthenticated ? (
              ...
              <>
                <Link
                  ...
                  className="px-7 py-3.5 rounded-xl font-bold text-base text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                >
                  {t('auth.signIn')}
                </Link>
                <Link
                  href={`/${locale}/auth/signup`}
                  className="px-7 py-3.5 rounded-xl font-bold text-base bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors"
                >
                  {t('auth.signUp')}
                </Link>
              </>
