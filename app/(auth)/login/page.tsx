          ...
          <div className="flex flex-col lg:flex-row min-h-[600px]">
            <div className="flex-1 p-8 space-y-6">
              <div className="text-center space-y-2 animate-in fade-in slide-in-from-top-4 duration-700 delay-300">
                ...
                <h1 className="text-4xl font-light text-white tracking-tight uppercase">{t('auth.login.welcomeBack')}</h1>
                <p className="text-white/70 text-sm">{t('auth.login.signInToAccount')}</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white/90 block">{t('auth.login.emailLabel')}</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-white/90 block">{t('auth.login.passwordLabel')}</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center space-x-2 text-white/80 cursor-pointer">
                    <input
                      ...
                      className="sr-only"
                    />
                    <div className={`w-4 h-4 bg-white/20 border border-white/30 rounded flex items-center justify-center transition-colors ${rememberMe ? 'bg-orange-500 border-orange-500' : ''}`}>
              ...
              <div className="relative flex items-center animate-in fade-in duration-700 delay-700">
                ...
                <span className="px-3 text-white/60 text-sm">{t('auth.login.orDivider')}</span>
                <div className="flex-1 border-t border-white/20"></div>
              </div>
...
<div className="space-y-4">
                  ...
                  <h2 className="text-4xl font-light text-white tracking-tight">{t('auth.login.transformJourney')}</h2>
                  <p className="text-white/70 text-lg leading-relaxed">{t('auth.login.transformJourneyDesc')}</p>
                </div>
...
<div className="flex items-start space-x-3 animate-in fade-in slide-in-from-right-4 duration-700 delay-500">
                    ...
                    <div>
                      <h3 className="text-white font-medium">{t('auth.login.feature1Title')}</h3>
                      <p className="text-white/60 text-sm">{t('auth.login.feature1Desc')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 animate-in fade-in slide-in-from-right-4 duration-700 delay-700">
                    ...
                    <div>
                      <h3 className="text-white font-medium">{t('auth.login.feature2Title')}</h3>
                      <p className="text-white/60 text-sm">{t('auth.login.feature2Desc')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 animate-in fade-in slide-in-from-right-4 duration-700 delay-900">
                    ...
                    <div>
                      <h3 className="text-white font-medium">{t('auth.login.feature3Title')}</h3>
                      <p className="text-white/60 text-sm">{t('auth.login.feature3Desc')}</p>
                    </div>
                  </div>
              </div>
...
<div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1100">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">{t('auth.login.testimonialAuthor')}</h4>
                      <p className="text-white/60 text-xs">{t('auth.login.testimonialRole')}</p>
                    </div>
                  </div>
                  <p className="text-sm font-light text-white/80">"{t('auth.login.testimonialQuote')}"</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-1300">
                  <div className="text-center">
                    ...
                    <div className="text-white/60 text-xs">{t('auth.login.statsActiveUsers')}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-semibold text-white">500+</div>
                    <div className="text-white/60 text-xs">{t('auth.login.statsDietitians')}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-semibold text-white">98%</div>
                    <div className="text-white/60 text-xs">{t('auth.login.statsSatisfaction')}</div>
                  </div>
                </div>
            </div>
          </div>
